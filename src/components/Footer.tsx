...
function Footer() {
  return (
    <>
      <footer className="theme-card shadow-sm relative p-4 md:py-8">
        ...
        <div className="flex items-center justify-center mb-6">
          ...
          <Link
            ...
            className="mx-4 theme-text text-2xl hover:text-blue-600 transition-colors"
          >
            <FaFacebook />
          </Link>
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mx-4 theme-text text-2xl transition-colors hover:text-[#E1306C]"
          >
            <FaInstagram />
          </Link>
          {/* Right line */}
        ...
        <div className="w-full max-w-screen-xl mx-auto flex flex-col md:flex-col items-center justify-between theme-text">
          {/* Left side - logo */}
          <Link
            to="/"
