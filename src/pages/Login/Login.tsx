...
export default function Login() {
  ...
  return !forgotPassword ? (
    <div className="flex flex-col min-h-screen justify-center items-center gap-5 w-full px-4 sm:px-8 theme-bg">
      {errorMessage && (
        <div className="bg-bgBlackTransparent fixed inset-0 flex items-center justify-center z-[1000] p-4">
          <div className="theme-card p-5 rounded-lg shadow-lg relative w-full max-w-[500px] h-auto min-h-[200px] sm:min-h-[250px] md:min-h-[300px]">
            <button
            ...
            <div className="flex flex-col justify-center items-center h-full text-center">
              <p className="text-base sm:text-lg mb-3 theme-text">{errorMessage}</p>
              {errorMessage !== "სახელი/მეილი ან პაროლი არასწორია" ? (
                <span className="text-sm sm:text-base theme-text">
                  დააჭირეთ{" "}
                  <Link
                ...
                <h1 className="text-sm sm:text-base theme-text">
      ...
      {isUserVerified === null ? (
        ...
        <>
          <h1 className="text-xl sm:text-2xl text-center theme-text">Offers Card</h1>
          <p className="text-sm sm:text-base text-center theme-text-secondary">
