...
import { extractIframeSrc } from "../../utils/mapUtils";
...
interface Voucher {
  ...
  fb?: string;
  insta?: string;
  iframe?: string; // Added iframe field for Google Maps
}
                ...
                <div className="w-full text-yellow-600 flex flex-col gap-4 text-start">
                  ...
                  {(data.company.iframe) && (
                    <div className="w-full ">
                      ...
                      {data.company.iframe ? (
                        <CompanyMap
                          iframeSrc={extractIframeSrc(data.company.iframe) || undefined}
                          companyName={data.company.object_name}
                        ...
                        <InteractiveMap
                          companyName={data.company.object_name}
                          address={data.company.adress}
                          city={JSON.parse(data.company.city || "[]")[0]}
                          className="w-full"
                        />
                      )}
                    </div>
              ...
              >
                <div className="relative w-full overflow-hidden rounded-xl shadow-lg">
                  <img
                    ...
                    src={item.photo_path}
                    className="w-full h-72 sm:h-80 md:h-[400px] object-contain rounded-xl shadow-lg"
                  />
                </div>
