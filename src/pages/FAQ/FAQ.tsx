...
const FAQ = () => {
  ...
  return (
    <div className="myContainer py-12 px-3 theme-bg min-h-screen">
      ...
      <div className="h-screen mt-10">
        ...
        {FAQ_Questions?.map((item: FAQItem, index: number) => (
          <div
            key={index}
            className="mb-7 theme-border border-yellowButton border-transparent border rounded-md"
          >
            <button
              className="w-full text-left p-4 font-medium theme-text theme-card rounded-lg focus:outline-none hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
            ...
            >
              <p
                className={`p-4 theme-text-secondary transition-opacity duration-500 ease-in-out ${
