...
export default function Profile() {
  ...
  return (
    <>
      ...
      <div className="h-screen theme-bg">
        {profileData ? (
          <div className="p-4 mt-10 sm:p-3">
            <div className="p-6 rounded-lg shadow-inner shadow-yellow-500 flex flex-col items-center w-full max-w-sm sm:max-w-md mx-auto mt-8 sm:p-3 theme-card">
              <div className="profile-details w-full">
                <div className="flex flex-col items-center mb-6">
                  <p className="font-bold theme-text">{profileData.username}</p>
                  <p className="text-sm sm:text-base theme-text-secondary">{profileData.email}</p>
                </div>
                <div className="grid grid-cols-1 gap-4 text-left">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      ...
                      <p className="ml-2 text-sm sm:text-base theme-text-secondary">
                    ...
                    <button
                      ...
                      } theme-text px-2 py-1 text-sm rounded-lg ml-4 flex gap-2 items-center hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors`}
                    >
                      <i
                        className={`  text-${
                          copySuccess
                  ...
                  <div className="flex justify-between items-center gap-4">
                    <span className="theme-text">ავტომატური გამოწერა:</span>
                    ...
                    <button
                      className="bg-yellow-500 text-black px-3 py-1 rounded hover:bg-yellow-600 transition font-medium"
                  ...
                  {profileData.subscription ? (
                    ...
                    <button
                      className="p-2 bg-yellow-500 mt-3 rounded-2xl text-black font-medium hover:bg-yellow-600 transition-colors"
                      onClick={() => {
                        handleRedirect();
                      }}
                    >
