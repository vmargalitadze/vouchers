  ...
  return (
   ...
   <div className="flex flex-col items-center p-6  rounded-xl shadow-lg gap-5 w-full md:basis-1/2 text-center text-white transition-shadow hover:shadow-yellow-500/50">
      ...
      <div className="flex flex-col items-center p-6 bg-gray-800 rounded-xl shadow-lg gap-5 w-full md:basis-1/2 text-center text-white transition-shadow hover:shadow-yellow-500/50">
        ...
        <Link to={"https://www.facebook.com/techspaceingeorgia"} target="_blank" rel="noopener noreferrer">
      ...
      <div className="flex flex-col items-center p-6 bg-gray-800 rounded-xl shadow-lg gap-5 w-full md:basis-1/2 text-center text-white transition-shadow hover:shadow-yellow-500/50">
        <img src={test} alt="Offers Card logo" className="w-20 sm:w-24 h-auto mb-3" />
        ...
        <p className="text-sm text-gray-400">
          ...
          შეთავაზებებს რესტორნებში, ბარებში, კაფეებში, სასტუმროებში,
          სილამაზისა და გასართობ ობიექტებში და სხვა სერვისებში. ჩვენი ბარათის
          საშუალებით თქვენ შეგიძლიათ მიიღოთ, როგორც 1+1 შეთავაზება, ასევე
          პროცენტული დანაზოგები ან სხვა სახის ბენეფიტები. გახდით Offers Card-ის
          მომხმარებელი და დაზოგეთ თქვენი ფინანსები.
        </p>
        <div className="mt-4 pt-4 border-t border-gray-700 w-full">
          <h3 className="text-lg font-semibold text-yellow-500 mb-2">ჩვენი მიზანია</h3>
          <p className="text-sm text-gray-400">
