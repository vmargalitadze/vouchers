...
export default function MiddleTopCards() {
  return (
    <div className="flex flex-col items-center p-6 rounded-xl shadow-lg gap-5 w-full md:basis-1/2 text-center theme-text">
      <VideoThumbnail
        thumbnailUrl="/offerscard.jpg"
        videoUrl="/Offerscard.mp4"
      />
      {/* Card 1: Become a Partner */}
      <div className="flex flex-col items-center p-6 theme-card rounded-xl shadow-lg gap-5 w-full md:basis-1/2 text-center theme-text transition-shadow hover:shadow-yellow-500/50">
        <img
          src={partner}
      ...
      <div className="flex flex-col items-center p-6 theme-card rounded-xl shadow-lg gap-5 w-full md:basis-1/2 text-center theme-text transition-shadow hover:shadow-yellow-500/50">
        ...
        <div className="mt-4 pt-4 theme-border border-t w-full">
